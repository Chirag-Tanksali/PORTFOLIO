                    ...
                    <div className="role">
                        <OwlCarousel className='owl-carousel' id='projects-carousel' {...options}>
                            <div className='col-lg-12'>
                                <div className='project-item'>
                                    <div className='project-comment'>
                                        <h3>Discuss-mates : Video and Voice call Web application</h3>
                                        <p>
                            ...
                            <div className='col-lg-12'>
                                <div className='project-item'>
                                    <div className='project-comment'>
                                        <h3>CV / Resume Analysis using Python</h3>
                                        <p>
                                        Developed a  Python application which finds relevant fields of interest in which a candidate has got expertise and classify the relevant skills accordingly in a Pie chart . Thus , Resume screening saves recruiters time during the hiring process and leads to faster onboarding 
of new employees.
                                        </p>
                                    </div>
                                </div>
