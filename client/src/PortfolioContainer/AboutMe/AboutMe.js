                ...
                <div className="about-me-card">
                    ...
                    <div className="about-me-details">
                        ...
                        <div className="about-me-options">
                            <a href="https://drive.google.com/file/d/1sRNstWkHM8LHL_LgEtUpCPNXyRVS8j0b/view?usp=sharing" class="btn" target="_blank"> <button className='btn highlighted-btn'>Get Resume</button></a>
                        </div>
                    </div>
                </div>
            </div>
